...
export default {
  ...
  mounted () {
    ...
    this.numbreImg = Info.numbreImg
    this.message = Info.address

    let codeContent = 'iban:' + Info.address + '?tokenAddress=' + this.$route.params.tokenAddress + '&tokenSymbol=' + this.$route.params.tokenSymbol

    QRCode.toCanvas(document.getElementById('canvas'), codeContent, function (error) {
